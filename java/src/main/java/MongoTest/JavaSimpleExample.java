...
public class JavaSimpleExample {
    ...
    public static void main(String[] args) throws UnknownHostException{
        ...
        if (mongoUri == null) {
          mongoUri = "mongodb://localhost:10990/test";
        }

        //MongoClientURI uri  = new MongoClientURI("mongodb://sivethetest:v4XsVGAm93TKHwBtMrBsUMwtuM2Xxd1iucpfngCkzLCMCPDxm4tTsPbckhg6AQNQHQlFxzljBtKiTGQDpkg5zA==@sivethetest.documents.azure.com:10250/test?ssl=true&sslInvalidHostNameAllowed=true"); 
